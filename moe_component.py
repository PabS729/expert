...
class SparseDispatcher_mod(object):
    def __init__(self, num_experts, gates):
        ...
        # calculate num samples that each expert gets1
        #print(gates[63])
...
class MoE_mod(nn.Module):
    ...
    def noisy_top_k_gating(self, x, train, noise_epsilon=1e-2):
        ...
        #gates = torch.Tensor([i for i in gates if i != [nan, nan]],device="cuda")
    ...
    def forward(self, x, loss_coef, train=True):
        """Args:
        ...
        #print(expert_inputs[0].shape, expert_inputs[1].shape)
